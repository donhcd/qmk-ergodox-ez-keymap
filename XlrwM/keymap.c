...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_GRAVE,       KC_Q,           MT(MOD_LGUI, KC_W),MT(MOD_LALT, KC_E),LT(3, KC_R),    KC_T,           TT(1),                                          CW_TOGG,        KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_MINUS,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, LCTL(KC_A),     KC_LEFT_ALT,    LCTL(KC_D),     LCTL(KC_F),     KC_TRANSPARENT,                                                                 KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_TRANSPARENT, KC_TRANSPARENT,
...
const uint16_t PROGMEM combo8[] = { LT(6, KC_S), MT(MOD_LSFT, KC_F), COMBO_END};
const uint16_t PROGMEM combo9[] = { MT(MOD_LSFT, KC_J), LT(6, KC_L), COMBO_END};
