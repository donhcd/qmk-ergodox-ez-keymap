...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    MT(MOD_LCTL, KC_TAB),MT(MOD_LCTL, KC_A),LT(6, KC_S),    LT(2, KC_D),    MT(MOD_LSFT, KC_F),MT(MOD_LALT, KC_G),                                                                MT(MOD_LALT, KC_H),MT(MOD_LSFT, KC_J),KC_K,           LT(6, KC_L),    MT(MOD_LCTL, KC_SCLN),KC_QUOTE,
