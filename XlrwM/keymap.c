...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    LM(6,MOD_LGUI), KC_MEH,         LM(2,MOD_LGUI), KC_LEFT_ALT,    KC_LEFT_CTRL,                                                                                                   KC_LEFT_SHIFT,  MO(2),          MT(MOD_LSFT, KC_SPACE),KC_LBRC,        KC_RBRC,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, DM_RSTP,        KC_LBRC,        KC_RBRC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           ST_MACRO_1,     KC_TRANSPARENT,
