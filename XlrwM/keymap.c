...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_BSPC,        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_AUDIO_VOL_DOWN,                                KC_AUDIO_VOL_UP,KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_EQUAL,
    ...
    LM(5,MOD_LGUI), KC_MEH,         LM(2,MOD_LGUI), KC_LEFT_ALT,    KC_LEFT_CTRL,                                                                                                   KC_LEFT_SHIFT,  MO(2),          MT(MOD_LSFT, KC_SPACE),KC_LBRC,        KC_RBRC,
                                                                                    ...
                                                                                    KC_SPACE,       MT(MOD_LGUI, KC_ENTER),KC_LEFT_SHIFT,  KC_LEFT_SHIFT,  TD(DANCE_0),    KC_BSPC
  ),
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TAB,         KC_LEFT_GUI,    KC_TRANSPARENT, KC_ESCAPE,      KC_LEFT_ALT,                                                                                                    KC_ENTER,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_LEFT_GUI,    KC_TRANSPARENT, KC_PAUSE,       ST_MACRO_0,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, DM_RSTP,        KC_LBRC,        KC_RBRC,        KC_TRANSPARENT, KC_MINUS,       ST_MACRO_1,                                     KC_TRANSPARENT, KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           ST_MACRO_2,     KC_TRANSPARENT,
    KC_TRANSPARENT, KC_EQUAL,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_DOT,         KC_DOT,         KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_DELETE
  ),
  [3] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_LCBR,        KC_RCBR,        KC_LBRC,        KC_RBRC,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_W),     LCTL(KC_E),     KC_TRANSPARENT, LCTL(KC_T),     LGUI(KC_UP),                                    KC_TRANSPARENT, TD(DANCE_1),    LCTL(KC_U),     TD(DANCE_2),    KC_TRANSPARENT, KC_UP,          KC_TRANSPARENT,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_LSFT(SS_TAP(X_S))SS_DELAY(10)  SS_LSFT(SS_TAP(X_I))SS_DELAY(10)  SS_LSFT(SS_TAP(X_G))SS_DELAY(10)  SS_TAP(X_MINUS));
    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) {
