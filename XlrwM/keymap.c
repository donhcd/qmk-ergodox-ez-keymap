...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    LM(6,MOD_LGUI), KC_MEH,         KC_LEFT_SHIFT,  KC_LEFT_ALT,    KC_LEFT_CTRL,                                                                                                   LT(2, KC_SPACE),MO(2),          KC_LEFT_SHIFT,  KC_LBRC,        KC_RBRC,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, DM_RSTP,        KC_LBRC,        KC_RBRC,        KC_QUOTE,       KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           ST_MACRO_2,     KC_TRANSPARENT,
